...
# save to excel
survey.to_excel(r'C:\Users\soug9\Desktop\Shcard Summer School\data\survey17-27.xlsx')

# save to txt
with open(r'C:\Users\soug9\Desktop\Shcard Summer School\data\survey17-27.txt',"wb") as fp :
        pickle.dump(survey,fp)

with open(r'C:\Users\soug9\Desktop\Shcard Summer School\data\survey17-27.txt',"rb") as fp :
...
## merge custmer+transaction+online+survey ##

# load data
with open(r'C:\Users\soug9\Desktop\Shcard Summer School\data\custmer+transaction+online.txt',"rb") as fp :
        online_new = pickle.load(fp)         

# merge
survey = survey.drop(['SEX_CCD'],axis=1)
merge = pd.merge(online_new, survey, on='CLNN')

# save to excel
merge.to_excel(r'C:\Users\soug9\Desktop\Shcard Summer School\data\custmer+transaction+online+survey.xlsx')

# save to txt
with open(r'C:\Users\soug9\Desktop\Shcard Summer School\data\custmer+transaction+online+survey.txt',"wb") as fp :
        pickle.dump(merge,fp)

with open(r'C:\Users\soug9\Desktop\Shcard Summer School\data\custmer+transaction+online+survey.txt',"rb") as fp :
        merge_test = pickle.load(fp)   
